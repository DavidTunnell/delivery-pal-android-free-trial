...
public class SharedPref extends Activity {
	...
	public static final String calenderTrial = "Calender_Trial";
	public static final String daysLeftTrial = "Days_Left_Trial";
	...
	public void populatedSharedPref() {
		...
		if (getSavedData(calenderTrial, this) == null) {
			Calendar firstDay = Calendar.getInstance();
			long startMilisecs = firstDay.getTimeInMillis();
			saveToSP(calenderTrial, String.valueOf(startMilisecs), this);
		}
	}
}
